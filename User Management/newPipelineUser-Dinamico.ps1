...
function New-VeracodePipelineUser {
    ...
    Write-Host "##vso[task.setvariable variable=VeracodeID;issecret=false]$VeracodeID"
    Write-Host "##vso[task.setvariable variable=VeracodeKey;issecret=false]$VeracodeKey"
}